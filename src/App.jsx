...
const filterPosts = (posts, recherche, query_type, query_categorie, rechercheTexte) => {
...
function App() {
	...
	const filteredPosts = filterPosts(posts, recherche, query_type, query_categorie, rechercheTexte);
	...
	return (
		<div className="App">
			...
			<button id='full-drop'><Link to={'/connexion'}>Se connecter</Link></button>
			{/* <button id='full-drop'><Link to={'/inscription'}>S'inscrire</Link></button> */}
			<Deconnexion/>
			<SearchBar/>
			<CreateArticle/>
			<p id="statut"></p>
			{/* <p>Vous avez recherché : {rechercheTexte}</p> */}
			<div className="card">
				{posts.length > 0 &&
